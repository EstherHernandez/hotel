...
class FrontEnd {
   ...
   public function procesarFormulario() {
        if (isset($_POST["nombre"]) && isset($_POST["apaterno"]) && isset($_POST["amaterno"]) && isset($_POST["email"]) && isset($_POST["telefono"]) &&
                ...
                isset($_POST["Nhabitaciones"]) && isset($_POST["NhuespedesA"]) && isset($_POST["NhuespedesN"]) && isset($_POST["Thabitacion"])) {
            if ($this->modelo->insertarFormulario($_POST["nombre"],$_POST["apaterno"],$_POST["amaterno"],$_POST["email"],$_POST["telefono"], 
                    $_POST["direccion"],$_POST["ciudad"],$_POST["pais"],$_POST["postal"],$_POST["fechaLlegada"],$_POST["Nnoches"], 
                    $_POST["Nhabitaciones"],$_POST["NhuespedesA"],$_POST["NhuespedesN"],$_POST["Thabitacion"])) {
                $this->mensaje("Reservacion enviada");
            }else{
                $this->mensaje("Error al enviar formulario, intente de nuevo");
            }
        }
        return '';
    }
